		 ...
		 off_t offset, struct fuse_file_info *fi)
{
	...
	return storage_readdir(path, buf, filler, offset, fi);
}
	      ...
	      struct fuse_file_info *fi)
{
	...
	return storage_read(path, buf, size, offset, fi);
}
	       ...
	       struct fuse_file_info *fi)
{
	...
	return storage_write(path, buf, size, offset, fi);
}
